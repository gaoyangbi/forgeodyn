    ...
    !=========================================================================
        ...
        do l2i = 1, l2
             ...
             do m2i = 0, l2i
                ...
                call ast2h(as(1,1,1,2), tmax, pmax, rs2, l1, gauth, gauwt, p1)

                ! Small improvement: avoiding looping several times over n1
                do i=1, n1
                    Ab(rsc,i)=Ab(rsc,i)+rt1(i)*eqwts(i)
                    Ab(n2+rsc,i)=Ab(n2+rsc,i)+rs1(i)*eqwts(i)

                    if (m2i > 0) then
                        Ab(rss,i)=Ab(rss,i)+rt2(i)*eqwts(i)
                        Ab(n2+rss,i)=Ab(n2+rss,i)+rs2(i)*eqwts(i)
                    endif
                enddo
